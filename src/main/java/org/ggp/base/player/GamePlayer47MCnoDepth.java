...
public final class GamePlayer47MCnoDepth extends Thread implements Subject
{
    ...
    public GamePlayer47MCnoDepth(int port, Gamer gamer) throws IOException
    {
        ...
        try {
          ...
          //  GamePlayer player = new GamePlayer(9147, new ABGamer());
           ...
           // GamePlayer player = new GamePlayer(9148, new ABTTGamer());
            ...
            GamePlayer47MCnoDepth player = new GamePlayer47MCnoDepth(9147, new MCGamer());
            player.run();

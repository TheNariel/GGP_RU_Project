...
public final class GamePlayer55Random3 extends Thread implements Subject
{
    ...
    public GamePlayer55Random3(int port, Gamer gamer) throws IOException
    {
        ...
        try {
          ...
          //  GamePlayer player = new GamePlayer(9147, new ABGamer());
           ...
           // GamePlayer player = new GamePlayer(9148, new ABTTGamer());
            ...
            GamePlayer55Random3 player = new GamePlayer55Random3(9152, new RandomGamer());
            player.run();

...
public final class GamePlayer52Random extends Thread implements Subject
{
    ...
    public GamePlayer52Random(int port, Gamer gamer) throws IOException
    {
        ...
        try {
          ...
          //  GamePlayer player = new GamePlayer(9147, new ABGamer());
           ...
           // GamePlayer player = new GamePlayer(9148, new ABTTGamer());
            ...
            GamePlayer52Random player = new GamePlayer52Random(9152, new RandomGamer());
            player.run();

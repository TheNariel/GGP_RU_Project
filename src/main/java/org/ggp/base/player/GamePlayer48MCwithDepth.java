...
public final class GamePlayer48MCwithDepth extends Thread implements Subject
{
    ...
    public GamePlayer48MCwithDepth(int port, Gamer gamer) throws IOException
    {
    ...
    public static void main(String[] args)
    {
       /* if (args.length != 1) {
        ...
        try {
          ...
          //  GamePlayer player = new GamePlayer(9147, new ABGamer());

           // GamePlayer player = new GamePlayer(9148, new ABTTGamer());

            GamePlayer48MCwithDepth player = new GamePlayer48MCwithDepth(9148, new MCGamerGoalDistanceHeuristics());
            player.run();

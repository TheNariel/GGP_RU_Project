...
public final class GamePlayer53Random2 extends Thread implements Subject
{
    ...
    public GamePlayer53Random2(int port, Gamer gamer) throws IOException
    {
        ...
        try {
          ...
          //  GamePlayer player = new GamePlayer(9147, new ABGamer());
           ...
           // GamePlayer player = new GamePlayer(9148, new ABTTGamer());
            ...
            GamePlayer53Random2 player = new GamePlayer53Random2(9152, new RandomGamer());
            player.run();
